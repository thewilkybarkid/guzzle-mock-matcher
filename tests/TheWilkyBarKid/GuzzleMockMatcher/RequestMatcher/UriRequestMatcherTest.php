...
namespace TheWilkyBarKid\GuzzleMockMatcher\RequestMatcher;

use PHPUnit_Framework_TestCase as TestCase;

class UriRequestMatcherTest extends TestCase
{
    public function testInstanceOf()
    {
        $matcher = new UriRequestMatcher();

        $this->assertInstanceOf('TheWilkyBarKid\GuzzleMockMatcher\RequestMatcher\RequestMatcherInterface', $matcher);
    }
